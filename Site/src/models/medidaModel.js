...
function buscarUltimasMedidas(idAmb) {
        ...
        WHERE dt.fkEmp = ${idAmb} ORDER by dataHist DESC limit 5;`
...
function buscarMedidasEmTempoReal(idAmb) {
       var instrucaoSql = `SELECT h.dataHist, h.dadoCap, s.tipoSensor, s.unidMedida FROM unidadedatacenter as dt JOIN ambiente as a ON a.fkDC = dt.idDataCenter JOIN sensor as s  ON s.fkAmb = a.idAmb JOIN hist as h ON h.fkSensor = s.idSensor
